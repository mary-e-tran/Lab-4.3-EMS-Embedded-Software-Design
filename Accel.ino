...
void loop() {
  ...
  if (millis() - lastDisplay > 500) {
    ...
    Serial.print("X_g = ");
    Serial.print(-x_g_value); //x, y and z values that are being printed are flipped for readability. (i.e. it aligns with positive directions on accelerometer.)
    Serial.print("\t");
    Serial.print("y_g = ");
    Serial.print(-y_g_value); //x, y and z values that are being printed are flipped for readability. (i.e. it aligns with positive directions on accelerometer.)
    Serial.print("\t");
    Serial.print("z_g = ");
    Serial.print(-z_g_value); //x, y and z values that are being printed are flipped for readability. (i.e. it aligns with positive directions on accelerometer.)
    Serial.print("\n\n");
  }
